...
Start-Process -FilePath 'C:\Users\WDAGUtilityAccount\Desktop\MozillaFirefox\Deploy-Application.exe' -Wait
...
Start-Process -FilePath 'C:\Users\WDAGUtilityAccount\Desktop\MozillaFirefox\Deploy-Application.exe' -ArgumentList 'Uninstall' -Wait
